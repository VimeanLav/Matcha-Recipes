...
class _EditRecipeScreenState extends State<EditRecipeScreen> {
  ...
  void initState() {
    ...
    _timeController.text = recipe.timeMinutes.toString();
  ...
  Future<void> _submit() async {
    ...
    if (user == null || user.uid != widget.recipe.createdBy) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('You can only edit your own recipe.')),
      );
      return;
    }
    ...
    try {
      ...
      await _recipeService.updateRecipe(
        ...
        updates: {
          ...
          'category': recipeCategoryToString(_category!),
              ...
              Row(
                children: [
                  ...
                  _CategoryPill(
                    ...
                    onTap: () =>
                        setState(() => _category = RecipeCategory.desserts),
                  ),
                ],
              ),
              const SizedBox(height: 18),
